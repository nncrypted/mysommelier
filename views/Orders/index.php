		...
		echo GridView::widget([
			...
			'columns' => [
				...
				[
					...
					'format' => [
						'datetime',
						(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y'
					]
				], 
				'futures_flg', 
				[
					'attribute' => 'exp_delivery_dt',
					'format' => [
						'date',
						...
						'update' => function ($url, $model) 
							{
								return Html::a('<span class="glyphicon glyphicon-pencil"></span>', 
											Yii::$app->urlManager->createUrl(['orders/view','id' => $model->id,'edit'=>'t']), 
											[
